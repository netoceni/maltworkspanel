# Publicação do Maltworks Cloud Panel — Fase 5.13.0
...
Esta versão usa a API 5.10.0 e o firmware 5.3.3 para administrar receitas,
...
depois de atualizar a API e aplicar as migrações até `0010_notification_center.sql`.
Para usar o novo código seguro de cadastro, grave o firmware 5.3.3 no controlador.
